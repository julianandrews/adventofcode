...
func TestCase1(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, vm.Memory.Get(0), int64(3500))
}
...
func TestCase2(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, []int64{2, 0, 0, 0, 99}, vm.Memory.CopySlice(0, 5))
}
...
func TestCase3(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, []int64{2, 3, 0, 6, 99}, vm.Memory.CopySlice(0, 5))
}
...
func TestCase4(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, []int64{2, 4, 4, 5, 99, 9801}, vm.Memory.CopySlice(0, 6))
}
...
func TestCase5(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Equal(t, []int64{30, 1, 1, 4, 2, 5, 6, 0, 99}, vm.Memory.CopySlice(0, 9))
}
