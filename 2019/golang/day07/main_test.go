...
func TestPart1_1(t *testing.T) {
	...
	assert.Equal(t, int64(43210), part1(program))
}
...
func TestPart1_2(t *testing.T) {
	...
	assert.Equal(t, int64(54321), part1(program))
}
...
func TestPart1_3(t *testing.T) {
	...
	assert.Equal(t, int64(65210), part1(program))
}
...
func TestPart2_1(t *testing.T) {
	...
	assert.Equal(t, int64(139629729), part2(program))
}
...
func TestPart2_2(t *testing.T) {
	program := []int64{
		...
		1001, 55, 1, 55, 2, 53, 55, 53, 4, 53, 1001, 56, -1, 56, 1005, 56,
		6, 99, 0, 0, 0, 0, 10,
	}
	assert.Equal(t, int64(18216), part2(program))
}
